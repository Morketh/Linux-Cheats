...
#######################################################################
# TODO: add a file reader to pull hashes from textfile
# add in a MySQL INSERT statment to load the torrents into a database
# add in a MySQL UPDATE statment to refresh DB data
#######################################################################
